...
function conversation(overrides: Partial<Conversation>): Conversation {
  return {
    ...
    endedAt: "2026-07-01T00:01:00Z", turns: [], sourcePath: "/source", contentHash: "a".repeat(64),
    ...overrides,
  };
}
...
test("separates provider-specific non-cached and cached token semantics", async () => {
  ...
  indexConversation(db, conversation({
    id: "codex", provider: "openai", harness: "codex", sourcePath: "/codex", contentHash: "b".repeat(64),
